...
'''
This project to detection  eyes and determines whether a person closes his eyes or not 
If he sleeps for more than 10 seconds, he starts counting to determine the duration of sleep and plays an alarm sound to wake him up.
'''
